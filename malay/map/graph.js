/* =========================================================
   /malay/map/graph.js
   Force-directed mega map for PSLE Bahasa Melayu.
   - All nodes loaded once from /malay/shared/content/mega.json.
   ...
   - Pattern ported from /studio/map/graph.js, simplified.
...
(function () {
  ...
  init().catch(err => {
    ...
    if (probe) probe.innerHTML = '<div class="fk">Ralat</div><div class="fl">Tidak dapat memuat peta.</div><div class="ft">' + err.message + '</div>';
  });
})();
