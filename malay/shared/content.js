/* =========================================================
   /malay/shared/content.js
   Loads PSLE Malay theme content JSON from
   /malay/shared/content/. Themes correspond to syllabus
   strands rather than science domains.
   Exposes window.MalayContent.
   ========================================================= */

(function (global) {
  const THEMES = ['tatabahasa', 'kosakata', 'peribahasa', 'kefahaman', 'penulisan'];
